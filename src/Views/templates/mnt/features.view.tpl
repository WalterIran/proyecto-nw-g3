...
<section class="WWListFeatures">
  <table class="min-w-full">
    <thead>
      ...
      <th>
        {{if CanInsert}}
        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded " href="index.php?page=mnt_feature&mode=INS&fncod=AUTOMATIC">Nuevo</a>
        {{endif CanInsert}}
    ...
    <tbody class="bg-white">
      ...
      <tr>
        ...
        <td class="flex justify-items-center place-content-center">
          {{if ~CanUpdate}}
          <a href="index.php?page=mnt_feature&mode=UPD&fncod={{fncod}}" title="Editar">
          ...
          &nbsp;
          {{if ~CanDelete}}
          <a href="index.php?page=mnt_feature&mode=DEL&fncod={{fncod}}" title="Eliminar">
